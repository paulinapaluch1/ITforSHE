...
public class Main extends Application {
    ...
    static final int MAX_HAND_SIZE = 36;
    static final int MIN_AMOUNT_OF_TRICKS = 1;
    static final int MAX_AMOUNT_OF_TRICKS = 7;
    static final int COL_WITH_IMP_RESULT = 2;
    static final int LAST_ROW_IN_IMP_TABLE = 23;
    static final int MINIMAL_RANGE_OFFSET = 1;
    static final int MAXIMUM_RANGE_OFFSET = 2;
    static final int ROWS_IN_IMP_TABLE = 24;
    static final int COLS_IN_INP_TABLE = 3;
    static final int ROWS_IN_HAND_VALUES_TABLE = 16;
    static final int COLS_IN_HAND_VALUE_TABLE = 3;
    static final int ROWS_IN_GAMES_TABLES = 8;
    static final int COLS_IN_GAMES_TABLES = 13;
    static final String HAND_VALUES_FILE_PATH = "src/main/resources/HandValues.csv";
    static final String IMP_VALUES_FILE_PATH = "src/main/resources/IMPValues.csv";
    static final String GAME_VALUES_BEFORE_MATH_FILE_PATH = "src/main/resources/GameValuesBeforeMatch.csv";
    static final String GAME_VALUES_AFTER_MATH_FILE_PATH = "src/main/resources/GameValuesAfterMatch.csv";
